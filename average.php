...
$q7=$_POST['item7'] ?? null;
$q8=$_POST['item8'] ?? null;
$sql = "INSERT INTO `canteenfeedbacksystem`(`item1`, `item2`, `item3`, `item4`, `item5`, `item6`, `item7`, `item8`, `feedback_date`, `feedback_time`) VALUES ('$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$date','$time')";
